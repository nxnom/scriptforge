...
- Visual-direction choosers now reserve a 4px transparent border on unselected designs, then reveal a palette-specific high-contrast color without shifting the layout.
