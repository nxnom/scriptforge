...
8. Review and save the exact candidate revision that was presented; detect changes made after review.
9. Preview runs are optional and never a prerequisite for Save. A script change still requires Codex to repeat its bounded standalone check before presenting the revised candidate.
