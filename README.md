...
- **Tool identity:** Grid cards, list rows, and detail sidebars use one stable primary-category accent for the icon and top edge, neutral category chips, semantic readiness colors, and a quiet indigo Built-in trust badge. Tool identity remains stable across layouts, navigation, and reloads without competing badge colors.
