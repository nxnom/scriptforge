...
- **Tool identity:** Grid cards, list rows, and detail sidebars use one stable primary-category accent for the icon and top edge, neutral category chips, attention-only status badges, and a quiet indigo Built-in trust badge. Ready tools need no redundant badge; exceptions stay visible.
