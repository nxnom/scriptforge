...
- The Start Forge dialog defaults to a fresh session but can select, resume, or inline-confirm deletion of stopped/interrupted sessions; resumed work continues the exact Codex conversation in its preserved staging directory
