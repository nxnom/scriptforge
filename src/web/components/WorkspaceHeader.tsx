  ...
  return (
    <header className="h-16 shrink-0 border-[#333] border-b bg-[#1a1a1a] px-10 max-[900px]:px-6 max-[560px]:px-4">
      <div className="mx-auto flex h-full w-full max-w-320 items-center gap-4">
        <Button aria-label="Back to Library" className="shrink-0" variant="outlined" size="sm" onClick={onBack}>
          <ArrowLeft size={14} /> <span className="max-[560px]:hidden">Library</span>
        </Button>
        <span aria-hidden="true" className="h-7 w-px shrink-0 bg-[#303030] max-[560px]:hidden" />
