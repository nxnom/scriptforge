    ...
    >
      {available && (
        <Link
          ...
          className="absolute inset-0 cursor-pointer rounded-2xl focus-visible:outline-2 focus-visible:outline-[#777]"
          to={`/tools/${tool.id}`}
        />
      )}
      <div
      ...
      >
        ...
        <div className="flex items-center justify-between">
          ...
          {tool.origin === "installed" ? (
            ...
            !available && <span className="text-[11px] text-[#7a7a7a]">Soon</span>
          )}
        </div>
      </div>
    </article>
